...
type TripServiceClient interface {
	GetTrip(ctx context.Context, in *TripRequest, opts ...grpc.CallOption) (*TripResponce, error)
}
...
func (c *tripServiceClient) GetTrip(ctx context.Context, in *TripRequest, opts ...grpc.CallOption) (*TripResponce, error) {
	out := new(TripResponce)
...
type TripServiceServer interface {
	GetTrip(context.Context, *TripRequest) (*TripResponce, error)
...
func (UnimplementedTripServiceServer) GetTrip(context.Context, *TripRequest) (*TripResponce, error) {
